...
baseURL = "https://nips.cc/Conferences/2018/Schedule"
...
for (item_id in item_ids){
  print(item_id)
  url = paste0("https://nips.cc/Conferences/2018/Schedule?showEvent=", item_id)
  ...
  date = paste(c(dateComponents, "2018"), collapse=" ")
  ...
  if (!is.na(paper_url) & grepl("http", paper_url)){
    tmp = GET(paper_url)
